...
public class individualIdentification_record extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public individualIdentification_record(String identificationId, String identificationType, String issuingDate, String issuingAuthority, String placeOfIssue, validFor_record validFor) {
  ...
  public void put(int field$, Object value$) {
    ...
    case 3: issuingAuthority = (String)value$; break;
    case 4: placeOfIssue = (String)value$; break;
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<individualIdentification_record>
    ...
    public individualIdentification_record build() {
      try {
        ...
        record.issuingAuthority = fieldSetFlags()[3] ? this.issuingAuthority : (String) defaultValue(fields()[3]);
        record.placeOfIssue = fieldSetFlags()[4] ? this.placeOfIssue : (String) defaultValue(fields()[4]);
        if (validForBuilder != null) {
