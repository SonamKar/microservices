...
public class engagedParty_record extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public engagedParty_record(String at_referredType, String givenName, String middleName, String familyName, String fullName, String gender, String birthDate, String nationality, individualIdentification_record individualIdentification, contactMedium_record contactMedium, partyCharacteristic_record partyCharacteristic) {
  ...
  public void put(int field$, Object value$) {
    ...
    case 6: birthDate = (String)value$; break;
    case 7: nationality = (String)value$; break;
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<engagedParty_record>
    ...
    public engagedParty_record build() {
      try {
        ...
        record.birthDate = fieldSetFlags()[6] ? this.birthDate : (String) defaultValue(fields()[6]);
        record.nationality = fieldSetFlags()[7] ? this.nationality : (String) defaultValue(fields()[7]);
        if (individualIdentificationBuilder != null) {
